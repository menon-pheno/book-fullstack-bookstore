...
我們回頭來審視一下 [Material-UI Nextjs 官方範例](https://github.com/mui/material-ui/tree/master/examples/nextjs)，提醒一下，這個範例就是我們第一章初始化專案時所使用的範例。值得一提的是，我個人認為整合的過程略嫌複雜，其實並不用完全了解每個步驟，我還是會針對每個步驟做個說明，但是如果讀者有地方真的無法了解的話，可以略過，其實並不會影響我們接下來的開發。
